...
static int alsa_renderer_init(void *context, const IHS_StreamAudioConfig *config) {
    int rc;
...
static int alsa_renderer_decode_and_play_sample(void *context, const uint8_t *data, size_t length) {
